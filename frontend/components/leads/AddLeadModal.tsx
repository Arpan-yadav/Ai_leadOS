            ...
            <div className="space-y-1 md:col-span-2">
              ...
              <div className="flex gap-2">
                <select 
                  ...
                  className="input-field w-32 bg-[#111114] light:bg-slate-50 border border-white/10 light:border-slate-200 rounded-lg text-white light:text-slate-900 focus:outline-none focus:border-[#00f0ff]"
                >
