      ...
      <div className={`p-4 border-t flex flex-col gap-2 ${isDark ? 'border-[#27272A]' : 'border-slate-200'}`}>
        ...
        >
          <Settings size={18} className={clsx(
            'transition-colors duration-300 shrink-0',
            pathname === '/settings' ? 'text-[#00f0ff]' : 'text-[#b9cacb] group-hover:text-[#00f0ff]'
          )} />
        ...
        <button 
          ...
          className="flex items-center gap-2.5 px-3 py-2 rounded-md text-[#b9cacb] hover:text-[#e5e1e4] hover:bg-[#27272A] transition-colors w-full"
        >
        ...
        {mounted && (
          <button 
            ...
            className="flex items-center gap-2.5 px-3 py-2 rounded-md text-[#b9cacb] hover:text-[#e5e1e4] hover:bg-[#27272A] transition-colors w-full mt-1"
            title="Toggle Theme"
          >
            {theme === 'dark' ? (
