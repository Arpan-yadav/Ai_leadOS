...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-white selection:bg-brand-100 selection:text-brand-900 animate-fade-in">
      {/* Navigation */}
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8 animate-slide-up">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4">
              <Link 
                href="/register"
                className="w-full sm:w-auto px-8 py-4 bg-brand-600 text-white font-black uppercase text-sm tracking-widest rounded transition-all hover:bg-brand-700 hover:scale-[1.02] active:scale-95 shadow-xl shadow-brand-500/20 text-center"
              >
