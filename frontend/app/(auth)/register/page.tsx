      ...
      <div className="flex flex-col items-center justify-center p-8 lg:p-24 bg-white animate-fade-in">
        <div className="w-full max-w-md space-y-8">
          <div className="text-center lg:text-left">
            <h2 className="text-3xl font-bold text-slate-900 tracking-tight uppercase">Create account</h2>
            <p className="text-slate-500 mt-2 font-medium">Initialize your enterprise workspace.</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                <User className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-hover:text-brand-500 transition-colors" size={20} />
                <input 
                  type="text" 
                  {...register('name')}
