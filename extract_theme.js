...
const targetFiles = [
  ...
  'c:\\Users\\Arpan yadav\\Desktop\\ProyoTech\\AI_LeadOS\\frontend\\app\\(main)\\leads\\page.tsx',
  'c:\\Users\\Arpan yadav\\Desktop\\ProyoTech\\AI_LeadOS\\frontend\\app\\(main)\\pipeline\\page.tsx',
];
        ...
        for (const tool of obj.tool_calls) {
          if (tool.name === 'write_to_file' || tool.name === 'default_api:write_to_file') {
            ...
            if (target && targetFiles.map(t => t.toLowerCase()).includes(target.toLowerCase())) {
              ...
              if (!fileContents[target.toLowerCase()]) {
